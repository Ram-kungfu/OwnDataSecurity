...
// Auth State Check - लॉगिन बदलते ही डेटा बदलने के लिए
onAuthStateChanged(auth, async (user) => {
    ...
    if (user) {
        ...
        // लॉगिन होते ही पुराना बैलेंस स्क्रीन से हटाकर 'लोडिंग' दिखाएं
        if(balanceDisplay) balanceDisplay.innerText = "₹ ..."; 
        
        // अब डेटाबेस से इस नई आईडी का असली बैलेंस लाएं
        await loadUserBalance(user.uid);
    } else {
        currentUser = null;
        if(logs) logs.innerText = "कृपया काम शुरू करने के लिए लॉगिन करें।";
        // लॉगआउट होने पर बैलेंस को तुरंत 0 करें
